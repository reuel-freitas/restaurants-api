...
RSpec.describe 'Restaurant Menus API', type: :request do
  ...
  path '/restaurants/{restaurant_id}/menus/{menu_id}' do
    get 'Recupera um menu específico de um restaurante' do
      tags 'Restaurant Menus'
      produces 'application/json'
      parameter name: :restaurant_id, in: :path, type: :integer, required: true,
                description: 'ID do restaurante'
      parameter name: :menu_id, in: :path, type: :integer, required: true,
  ...
  path '/restaurants/{restaurant_id}/menus/{menu_id}/menu_items' do
    get 'Lista todos os itens de menu de um menu específico de um restaurante' do
      tags 'Restaurant Menus'
      produces 'application/json'
      parameter name: :restaurant_id, in: :path, type: :integer, required: true,
                description: 'ID do restaurante'
